## **ХЭШИРОВАНИЕ - ПОЛНЫЙ КУРС ОТ ОСНОВ ДО ПРОДВИНУТЫХ ТЕХНИК**
...
*   **Reservoir Sampling** (из ветки struct)
...
*   **Специализированные алгоритмы**
    ...
    *   **Locality-Sensitive Hashing (LSH)** (перенесено из ветки struct, XI) - MinHash, SimHash, случайные проекции
