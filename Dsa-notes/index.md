...
- [2. Базовые алгоритмы и техники](#2-базовые-алгоритмы-и-техники)
  - [I. Сортировки](#i-сортировки)
    - [A. Квадратичные](#a-квадратичные)
    - [B. Эффективные O(n log n)](#b-эффективные-on-log-n)
    - [C. Линейные и почти линейные](#c-линейные-и-почти-линейные)
    - [D. Дополнительно](#d-дополнительно)
